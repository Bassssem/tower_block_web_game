    ...
    function triggerAnimation(){
        ...
        arrowSegment.draw('50%', '50% + 0.01', 0.8, {callback: function(){
         ...
         function reload(){
             ...
             The best &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
     ...
     <?php 
          ...
          $i=1;
            ...
            <div class="user">
              ...
              <img src="uploads/<?php echo $images['img'];?>" alt="" class="user-img">
              <div class="username"><?php echo $images['username'];?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?php echo $images['score'];?><a href="<?php echo $images['link'];?>"target="_blank"><input type="button" class="boton" value="follow"></a></div>
            </div>
